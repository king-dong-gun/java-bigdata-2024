...
# QMainWindow, QLabel, QPushButton 등은 QWidget을 상속한 자식 클래스 (부모 클래스의 능력들은 다 사용할 수 있음)
...
class qtApp(QWidget):  # QWidget이 가지고 있는 속성, 변수, 함수를 다 사용가능
    ...
    def initUI(self):
        ...
        label.setStyleSheet(('color: red;'
                             'blackground: black;')) # 라벨 색상스타일 설정 html css와 완전 동일
    ...
    def paintEvent(self, event) -> None:
        ...
        # paint.drawText(250, 400//2, 'Sorry, Jae Young!')
        paint.end() # 반드시 닫아야 함
